...
try:
    ...
    print('Plotly required to run this program, install via pip install' +
    ' plotly')
    exit()
...
try:
    ...
    print('Dash required to run this program, install via pip install' +
    ' dash')
    exit()

# program library imports
from bed_webview.Extract_Files import Build_All_session_visual_data
